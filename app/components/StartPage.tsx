...
//   imageUrl = "https://media.istockphoto.com/id/155006759/photo/colored-world-map-xxxl.jpg?s=612x612&w=0&k=20&c=w2zY26QM14VYj441hkraJeBRp9U5lqNLiC_nODI_TkA=",
//   startQuizLink = "/quiz",
//   onStartQuiz
// }) => {
//   return (
...
//         <button 
//           onClick={onStartQuiz}
//           className="block w-[200px] mx-auto py-4 bg-[#3498db] text-white text-center font-bold text-lg rounded transition-colors hover:bg-[#2980b9]"
//         >
//           Start Quiz
//         </button>
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f5] text-[#333]">
      <div className="max-w-[800px] mx-auto p-5">
        ...
        <div className="relative w-full h-[450px] rounded-lg mb-8 shadow-md overflow-hidden">
  <Image 
    src="/download.jpg" // ✅ Local image from public folder
    alt="World map network showing country connections"
    fill
    style={{ objectFit: 'cover' }}
    priority
